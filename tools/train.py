...
def main():
    ...
    logger.info(f'Model:\n{model}')
    # if (cfg.data.train['type'] != 'WaymoDataset') or (cfg.data.train['type'] != 'Kitti360Dataset'):
    ...
    model.CLASSES = datasets[0].CLASSES
    # args.checkpoint = '/home/maoyc/UltarLiDAR/work_dirs/utrallidar_waymo_cosine_scheduler/epoch_20.pth'
